...
\vspace{6pt}
\cvitem{Machine Learning}{classification, regression, clustering, feature engineering}
...
\cvitem{Programming}{Python (scikit-learn, pandas, numpy, scipy, matplotlib), C/C++, Fortran, Matlab, Mathematica, R, Linux, Git}
